...
date: '2021-11-02'
post_description: 'Mi sitio personal: Next.js, Tailwind CSS y export estático desplegado en AWS (S3 + CloudFront) con Terraform. Portafolio, blog bilingüe y playground personal.'
post_image_header: '/projects/this-page/monge1h.gif'
og_image: '/projects/this-page/og.png'
post_image_alt: 'Gif de este sitio web'
---
