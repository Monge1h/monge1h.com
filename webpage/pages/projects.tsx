		...
		<Layout>
			...
			<main className={`${styles.main_container_blog_posts}`}>
				...
				<section className={styles.blog_posts}>
					{ allPostsData.map(({id, date, title, post_description,post_image_header})=>(
						<PostCard key={id} title={title} post_image_header={post_image_header} date={date} post_description={post_description} id={id} redirectTo={'projects'}/>
					)) }
       			</section>
			</main>
		</Layout>
